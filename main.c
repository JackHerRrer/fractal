...
// iterMax = 127
// double = 1.3
void processFractalTriskel(PIXEL **fractal, double const constReel, double const constIm, double blowUpCarre, int const iterMax, double const zoom)
{
...
{   
    ...
    processFractalTriskel(fractal, constReel, constIm, blowUpCarre, iterMax, zoom);
